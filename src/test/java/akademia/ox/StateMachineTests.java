...
//        game =  OxRound.createRoundFromQuery("3 3 3", currentRoundNumber, bv, vc);
//    }
//
//    @Test
...
//        setPlayers();
//
//        GameState initialState = new InitialState(players, 1, messages, gameProperties);
//        //when
...
//        //given
//        setPlayers();
//        VictoryState victoryState = new VictoryState(players, game, GameResult.VICTORY, messages);
//        //when
...
//        //given
//        setPlayers();
//        GameState[] states = {new InProgressState(players, game, 1, messages), new InitialState(players, 1, messages, gameProperties), new VictoryState(players, game, GameResult.VICTORY, messages)};
//        //when // then
